...
execute if score Sleeping SonicSleep >= Half SonicSleep if score Ran SonicSleep matches 0 store result score CurrentTime SonicSleep run time query daytime
